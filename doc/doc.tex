...
\input{sections/coding-conventions.tex}
\input{sections/gui-programming.tex}
\input{sections/network-programming.tex}
\input{sections/file-processing.tex}
\input{sections/pcpp1.tex}
